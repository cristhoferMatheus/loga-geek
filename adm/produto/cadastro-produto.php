    ...
    <section class="conteiner">
        ...
        <div class="areaform">
            <form method="post" action="cadastro-produto-ok.php" enctype="multipart/form-data"> 
                ...
                <label for="imagem"><h3>Imagem:</h3></label>
				<input type="hidden" name="img" id="img" placeholder="escolha a imagem">
             ...
             <button name="add" class="button" type="submit"> Confirmar</button>
            </form>
        </div>
     </section>
