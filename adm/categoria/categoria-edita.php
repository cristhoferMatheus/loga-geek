...
if (isset($_GET['id']) && $_GET['id'] != "") {
    ...
    $categoriaData = $categoriaDao->selectById($categoria);
...
<body> 
    ...
    <section class="conteiner">
        <h2> Re-Cadastro da Categoria:</h2>
        <div class="areaform">
            <form method="post" action="categoria-edita-ok.php">
            <input type="hidden" name="id" value="<?php echo $categoriaData->getId(); ?>" >
